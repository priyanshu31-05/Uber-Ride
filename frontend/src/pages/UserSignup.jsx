    ...
    <div className='p-10 h-screen flex flex-col justify-between'>
      <div>
         ...
         required
          ...
          <div>
            <p className='text-[10px]'>By proceeding , you consent to get calls, whtsApp or SMS message , including by automated means , from Uber and its affiliates to the number provided</p>
          </div>
              </div>
  )
}
